...
// Demo kontrolünü buraya eklemeyi unutma (önceki konuşmamızdaki gibi)
...
// --- İŞLEM 2: SIRALAMAYI GÜNCELLE (YENİ ÖZELLİK) ---
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_orders'])) {
    ...
    // Gelen dizi: $_POST['order'] = [id => sira, id => sira]
...
// LİSTELEME (Sıraya göre çekiyoruz)
// Önce sort_order (Küçükten büyüğe), sonra ID (Yeniden eskiye)
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item">
                <a href="categories.php" class="active"><i class="ph-bold ph-list-dashes"></i> Kategoriler</a>
            </li>
            <li class="nav-item">
                <a href="products.php"><i class="ph-bold ph-hamburger"></i> Ürünler</a>
            </li>
            <li class="nav-item">
